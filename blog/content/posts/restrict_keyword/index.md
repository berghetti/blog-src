...
economiza um acesso à memória devido a não precisar carregar novamente o valor de `*a`, pois é garantido que o valor não foi modificado após sua atribuição inicial.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMzg0Mzg0OV19
-->